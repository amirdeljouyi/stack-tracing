 ...
 * every class in javafx package! Think before using
...
public class AllMethods {
    ...
    @OnMethod(
            clazz = "io.fxgame.game2048.GameManager",
            method = "/.*/"
    )
    public static void m(@Self Object o, @ProbeClassName String probeClass, @ProbeMethodName String probeMethod) throws FileNotFoundException {
